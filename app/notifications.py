...
def send_tenant_welcome_email(
    *,
    ...
    """Welcome a photographer invited by an admin — invite link or API key + getting-started."""
    ...
    if invite_url:
        body = (
            ...
            "Your studio account is ready. Open this one-time link to reveal your API key "
            "(it won't be shown again in the dashboard):\n\n"
            f"{invite_url}\n\n"
